...
Example calls:
$ python batch_create_lowrank.py -F 'relu_rank4_/' -nf 5 -te 400 -pe 250 -rank 4
...
if __name__ == "__main__":
    ...
    parser.add_argument('-F', '--folder', type=str, default='relu_rank4_/', 
    ...
    parser.add_argument('-rank', '--rank', type=int, default=4, help='Rank of recurrent weight matrix') 
    ...
    init_p =  { 'model_type':'LowRank', 'n1':n1, 'rank':rank, 'tau':tau, 'training_epochs':training_epochs, 'perturb_epochs':perturb_epochs, 'lr':lr, 'use_sigma':use_sigma,
