...
def analyse_files( files = None, savfolder='saved_plots/noise/', ext='.png',
    ...
    pp.figure()
    pp.errorbar(  np.log10(noise_range), np.mean(neu_beh_wout, axis=0) , yerr=np.std(neu_beh_wout, axis=0)/np.sqrt(nfiles-1),fmt='o-', color='b', label='wout')
    pp.errorbar(  np.log10(noise_range), np.mean(neu_beh_wint, axis=0) , yerr=np.std(neu_beh_wint, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='r', label='wint')
    pp.errorbar(  np.log10(noise_range), np.mean(neu_beh_pc12, axis=0) , yerr=np.std(neu_beh_pc12, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='g', label='pc12')
    pp.errorbar(  np.log10(noise_range), np.mean(neu_beh_wrng, axis=0) , yerr=np.std(neu_beh_wrng, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='k', label='wrng')
    pp.legend()    
    ...
    pp.figure()
    pp.errorbar(  np.log10(noise_range), np.mean(snr_wout, axis=0) , yerr=np.std(snr_wout, axis=0)/np.sqrt(nfiles-1),fmt='o-', color='b')
    pp.errorbar(  np.log10(noise_range), np.mean(snr_wint, axis=0) , yerr=np.std(snr_wint, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='r')
    pp.errorbar(  np.log10(noise_range), np.mean(snr_pc12, axis=0) , yerr=np.std(snr_pc12, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='g')
    pp.errorbar(  np.log10(noise_range), np.mean(snr_wrng, axis=0) , yerr=np.std(snr_wrng, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='k')
    pp.legend()
    ...
    pp.figure()
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wout, axis=0) , yerr=np.std(ratio_wout, axis=0)/np.sqrt(nfiles-1), fmt='o-',color='b', label='wout')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wint, axis=0) , yerr=np.std(ratio_wint, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='r', label='wint')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_pc12, axis=0) , yerr=np.std(ratio_pc12, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='g', label='pc12')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wrng, axis=0) , yerr=np.std(ratio_wrng, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='k', label='wrng')
    pp.legend()
    pp.xlabel('log noise sigma')
    pp.ylabel('AUC')#'Log signal-to-noise')#pp.ylabel('SNR in dB')
    #pp.ylim([-1,70])
    pp.plot([0,2],[0,0],'k--')
    pp.savefig(savfolder+fname+'_ratio_ndim_t'+np.str_(tOffset)+ext)
    pp.close()

    pp.figure()
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wout_neu, axis=0) , yerr=np.std(ratio_wout_neu, axis=0)/np.sqrt(nfiles-1), fmt='o-',color='b', label='wout')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wint_neu, axis=0) , yerr=np.std(ratio_wint_neu, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='r', label='wint')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_pc12_neu, axis=0) , yerr=np.std(ratio_pc12_neu, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='g', label='pc12')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wrng_neu, axis=0) , yerr=np.std(ratio_wrng_neu, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='k', label='wrng')
    pp.legend()
    pp.xlabel('log noise sigma')
    ...
    pp.figure()
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wout_task, axis=0) , yerr=np.std(ratio_wout_task, axis=0)/np.sqrt(nfiles-1), fmt='o-',color='b', label='wout')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wint_task, axis=0) , yerr=np.std(ratio_wint_task, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='r', label='wint')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_pc12_task, axis=0) , yerr=np.std(ratio_pc12_task, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='g', label='pc12')
    pp.errorbar(  np.log10(noise_range), np.mean(ratio_wrng_task, axis=0) , yerr=np.std(ratio_wrng_task, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='k', label='wrng')
    pp.legend()
    pp.xlabel('log noise sigma')
    ...
    pp.figure()
    pp.errorbar(  np.log10(noise_range), np.mean(hit_wout, axis=0) , yerr=np.std(hit_wout, axis=0)/np.sqrt(nfiles-1), fmt='o-',color='b', label='wout')
    pp.errorbar(  np.log10(noise_range), np.mean(hit_wint, axis=0) , yerr=np.std(hit_wint, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='r', label='wint')
    pp.errorbar(  np.log10(noise_range), np.mean(hit_pc12, axis=0) , yerr=np.std(hit_pc12, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='g', label='pc12')
    pp.errorbar(  np.log10(noise_range), np.mean(hit_wrng, axis=0) , yerr=np.std(hit_wrng, axis=0)/np.sqrt(nfiles-1),fmt='o-',color='k', label='wrng')
    pp.legend()
    pp.xlabel('log noise sigma')
